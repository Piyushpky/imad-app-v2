...
UPDATE application_config SET config_value = '1.0.9' where config_key = 'META_AVATAR-REG_VERSION' AND service_name = 'AVATAR-REG';
...
('avatar-reg.http.disable.hostname.verification','true', 'SERVICE','AVATAR-REG','1.0.9','AVATAR-REG');