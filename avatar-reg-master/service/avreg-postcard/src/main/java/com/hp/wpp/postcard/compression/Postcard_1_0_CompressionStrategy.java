 ...
 */
@Component
public class Postcard_1_0_CompressionStrategy implements CompressionStrategy {
	
	private static final WPPLogger LOG = WPPLoggerFactory.getLogger(Postcard_1_0_CompressionStrategy.class);
